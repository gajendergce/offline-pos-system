...
# Runs inventory sync via Laravel artisan command.
# Usage:
#   ./scripts/offline/sync-inventory.sh [store_id]
...
echo "Running offline:sync-inventory for store_id=$OFFLINE_STORE_ID"
...
echo "offline:sync-inventory completed."
